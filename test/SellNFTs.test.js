...
//      // init
//       const [owner, borrower, lender, fborrower, flender ] = await ethers.getSigners();
//       console.log("borrower:", borrower.address);
//       console.log("lender:", lender.address); 
//       console.log("fborrower:", fborrower.address); 
//       console.log("flender:", flender.address); 
...
//       await u20.connect(flender).mint();
//       await u20.connect(fborrower).mint();
...
//       const offeredTime = Number(1657138919);
...
//     // const offeredTime  = Number(1656719350)  ;
...
// const u20TokenFborrower = await u20.connect(fborrower).approve(swopXLanding.address, borrowerAmountApprove);
// await u20TokenFborrower.wait();
...
//   feePerinterest = res;
// });
//     const preloanTimes = ["1657138919", "0","16666666666666667", "2000000000000000000","10000000000000000000"];
//     const makePerPaymentloanTimestampLoanPayment =  ["1657138919", "0","16666666666666667", "2000000000000000000","10000000000000000000"];
...
//     const transferNft1 = await swopXLanding.connect(borrower).transferFrom(borrower.address, fborrower.address, 2);
//     await transferNft1.wait();
//     const makePerPayment = await swopXLanding.connect(fborrower).makePrePayment(nftreceipt, 1,
